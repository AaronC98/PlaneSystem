...
/* To help handle minimum version commands.  */

extern const char *version_major (int argc, const char **argv);
extern const char *default_version_min_opt (int argc, const char **argv);
extern const char *xcode_path (int argc, const char **argv);

#define DARWIN_EXTRA_SPEC_FUNCTIONS \
  { "version-major", version_major }, \
  { "default-version-min", default_version_min_opt }, \
...
#define DRIVER_SELF_SPECS					\
  ...
  "%{gsplit-dwarf:%ngsplit-dwarf is not supported on this platform } \
     %<gsplit-dwarf", \
  "%{!mmacosx-version-min=*:%:default-version-min()}"
...
#define ASM_MMACOSX_VERSION_MIN_SPEC \
  " %{mmacosx-version-min=*:-mmacosx-version-min=%:version-major(%*)}"
#else
#define ASM_MMACOSX_VERSION_MIN_SPEC ""
#endif
