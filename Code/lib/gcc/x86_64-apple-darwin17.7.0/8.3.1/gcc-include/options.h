...
enum opt_code
{
  ...
  OPT_Tbss_ = 141,                           /* -Tbss= */
  OPT_Tdata = 142,                           /* -Tdata */
  OPT_Tdata_ = 143,                          /* -Tdata= */
  OPT_Ttext = 144,                           /* -Ttext */
  OPT_Ttext_ = 145,                          /* -Ttext= */
  OPT_U = 146,                               /* -U */
  /* OPT_W = 147, */                         /* -W */
  OPT_Wa_ = 148,                             /* -Wa, */
  OPT_Wabi = 149,                            /* -Wabi */
  OPT_Wabi_tag = 150,                        /* -Wabi-tag */
  OPT_Wabi_ = 151,                           /* -Wabi= */
  ...
  OPT_X = 457,                               /* -X */
  OPT_Xassembler = 458,                      /* -Xassembler */
  OPT_Xlinker = 459,                         /* -Xlinker */
  OPT_Xpreprocessor = 460,                   /* -Xpreprocessor */
  OPT_Z = 461,                               /* -Z */
  OPT_Zall_load = 462,                       /* -Zall_load */
  OPT_Zallowable_client = 463,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 464,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 465,                   /* -Zbind_at_load */
  OPT_Zbundle = 466,                         /* -Zbundle */
  OPT_Zbundle_loader = 467,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 468,                     /* -Zdead_strip */
  OPT_Zdylib_file = 469,                     /* -Zdylib_file */
  OPT_Zdynamic = 470,                        /* -Zdynamic */
  OPT_Zdynamiclib = 471,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 472,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 473,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 474,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 475,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 476,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 477,                     /* -Zimage_base */
  OPT_Zinit = 478,                           /* -Zinit */
  OPT_Zinstall_name = 479,                   /* -Zinstall_name */
  OPT_Zmulti_module = 480,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 481,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 482,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 483,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 484,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 485,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 486,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 487,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 488,                  /* -Zsingle_module */
  OPT_Zumbrella = 489,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 490,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 491,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 492, */                  /* -all_load */
  /* OPT_allowable_client = 493, */          /* -allowable_client */
  OPT_ansi = 494,                            /* -ansi */
  OPT_arch = 495,                            /* -arch */
  /* OPT_arch_errors_fatal = 496, */         /* -arch_errors_fatal */
  OPT_aux_info = 497,                        /* -aux-info */
  /* OPT_aux_info_ = 498, */                 /* -aux-info= */
  OPT_auxbase = 499,                         /* -auxbase */
  OPT_auxbase_strip = 500,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 501, */              /* -bind_at_load */
  /* OPT_bundle = 502, */                    /* -bundle */
  /* OPT_bundle_loader = 503, */             /* -bundle_loader */
  OPT_c = 504,                               /* -c */
  OPT_client_name = 505,                     /* -client_name */
  OPT_compatibility_version = 506,           /* -compatibility_version */
  OPT_coverage = 507,                        /* -coverage */
  OPT_cpp = 508,                             /* -cpp */
  OPT_cpp_ = 509,                            /* -cpp= */
  OPT_current_version = 510,                 /* -current_version */
  OPT_d = 511,                               /* -d */
  /* OPT_dead_strip = 512, */                /* -dead_strip */
  /* OPT_dependency_file = 513, */           /* -dependency-file */
  OPT_dumpbase = 514,                        /* -dumpbase */
  OPT_dumpdir = 515,                         /* -dumpdir */
  OPT_dumpfullversion = 516,                 /* -dumpfullversion */
  OPT_dumpmachine = 517,                     /* -dumpmachine */
  OPT_dumpspecs = 518,                       /* -dumpspecs */
  OPT_dumpversion = 519,                     /* -dumpversion */
  /* OPT_dylib_file = 520, */                /* -dylib_file */
  OPT_dylinker = 521,                        /* -dylinker */
  OPT_dylinker_install_name = 522,           /* -dylinker_install_name */
  /* OPT_dynamic = 523, */                   /* -dynamic */
  /* OPT_dynamiclib = 524, */                /* -dynamiclib */
  OPT_e = 525,                               /* -e */
  OPT_export_dynamic = 526,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 527, */     /* -exported_symbols_list */
  OPT_fPIC = 528,                            /* -fPIC */
  OPT_fPIE = 529,                            /* -fPIE */
  OPT_fRTS_ = 530,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 531,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 532,                   /* -fabi-version= */
  OPT_faccess_control = 533,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 534,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 535,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 536,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 537,                  /* -falign-commons */
  OPT_falign_functions = 538,                /* -falign-functions */
  OPT_falign_functions_ = 539,               /* -falign-functions= */
  OPT_falign_jumps = 540,                    /* -falign-jumps */
  OPT_falign_jumps_ = 541,                   /* -falign-jumps= */
  OPT_falign_labels = 542,                   /* -falign-labels */
  OPT_falign_labels_ = 543,                  /* -falign-labels= */
  OPT_falign_loops = 544,                    /* -falign-loops */
  OPT_falign_loops_ = 545,                   /* -falign-loops= */
  /* OPT_faligned_new = 546, */              /* -faligned-new */
  OPT_faligned_new_ = 547,                   /* -faligned-new= */
  OPT_fall_intrinsics = 548,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 549, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 550,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 551,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 552, */   /* -falt-external-templates */
  OPT_fapple_kext = 553,                     /* -fapple-kext */
  /* OPT_fargument_alias = 554, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 555, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 556, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 557, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 558,            /* -fasan-shadow-offset= */
  OPT_fasm = 559,                            /* -fasm */
  OPT_fassociative_math = 560,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 561,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 562,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 563,                   /* -fauto-profile */
  OPT_fauto_profile_ = 564,                  /* -fauto-profile= */
  OPT_fautomatic = 565,                      /* -fautomatic */
  OPT_fbackslash = 566,                      /* -fbackslash */
  OPT_fbacktrace = 567,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 568,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 569,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 570,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 571,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 572,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 573,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 574,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 575,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 576,                        /* -fbuiltin */
  OPT_fbuiltin_ = 577,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 578,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 579,                   /* -fc-prototypes */
  OPT_fcall_saved_ = 580,                    /* -fcall-saved- */
  OPT_fcall_used_ = 581,                     /* -fcall-used- */
  OPT_fcaller_saves = 582,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 583,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 584,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 585,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 586, */            /* -fcf-protection */
  OPT_fcf_protection_ = 587,                 /* -fcf-protection= */
  OPT_fcheck_array_temporaries = 588,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 589,                /* -fcheck-data-deps */
  OPT_fcheck_new = 590,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 591,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 592,                         /* -fcheck= */
  OPT_fchecking = 593,                       /* -fchecking */
  OPT_fchecking_ = 594,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 595,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 596,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 597,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 598,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 599,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 600,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 601,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 602,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 603, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 604,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 605,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 606,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 607, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 608,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 609,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 610,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 611,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 612,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 613,                       /* -fcilkplus */
  OPT_fcoarray_ = 614,                       /* -fcoarray= */
  OPT_fcode_hoisting = 615,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 616,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 617,                         /* -fcommon */
  OPT_fcompare_debug = 618,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 619,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 620,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 621,                   /* -fcompare-elim */
  OPT_fconcepts = 622,                       /* -fconcepts */
  OPT_fcond_mismatch = 623,                  /* -fcond-mismatch */
  OPT_fconserve_space = 624,                 /* -fconserve-space */
  OPT_fconserve_stack = 625,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 626,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 627,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 628,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 629,                       /* -fconvert= */
  OPT_fcprop_registers = 630,                /* -fcprop-registers */
  OPT_fcray_pointer = 631,                   /* -fcray-pointer */
  OPT_fcrossjumping = 632,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 633,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 634, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 635,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 636,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 637,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 638,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 639,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 640,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 641,                       /* -fdbg-cnt= */
  OPT_fdce = 642,                            /* -fdce */
  OPT_fdebug_cpp = 643,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 644,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 645,            /* -fdebug-types-section */
  OPT_fdec = 646,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 647,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 648,                       /* -fdec-math */
  OPT_fdec_static = 649,                     /* -fdec-static */
  OPT_fdec_structure = 650,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 651,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 652,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 653,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 654, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 655,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 656,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 657,                /* -fdefault-real-16 */
  ...
  OPT_fdiagnostics_generate_patch = 668,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 669,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 670,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 671,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 672,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 673, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 674,                /* -fdirectives-only */
  OPT_fdisable_ = 675,                       /* -fdisable- */
  OPT_fdollar_ok = 676,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 677,         /* -fdollars-in-identifiers */
  OPT_fdse = 678,                            /* -fdse */
  ...
  OPT_fdump_final_insns = 683,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 684,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 685,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 686,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 687,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 688,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 689,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 690, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 691,                    /* -fdump-passes */
  OPT_fdump_scos = 692,                      /* -fdump-scos */
  ...
  OPT_fgo_dump_ = 762,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 763,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 764,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 765,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 766,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 767,                       /* -fgraphite */
  OPT_fgraphite_identity = 768,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 769,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 770, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 771, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 772, */                     /* -fhelp */
  /* OPT_fhelp_ = 773, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 774,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 775, */                /* -fhonor-std */
  OPT_fhosted = 776,                         /* -fhosted */
  /* OPT_fhuge_objects = 777, */             /* -fhuge-objects */
  OPT_fident = 778,                          /* -fident */
  OPT_fif_conversion = 779,                  /* -fif-conversion */
  OPT_fif_conversion2 = 780,                 /* -fif-conversion2 */
  OPT_filelist = 781,                        /* -filelist */
  OPT_fimplement_inlines = 782,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 783,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 784,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 785,             /* -fimplicit-templates */
  OPT_findirect_inlining = 786,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 787,         /* -findirect-virtual-calls */
  ...
  OPT_fipa_bit_cp = 810,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 811,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 812, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 813,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 814,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 815,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 816,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 817, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 818,                    /* -fipa-profile */
  OPT_fipa_pta = 819,                        /* -fipa-pta */
  OPT_fipa_pure_const = 820,                 /* -fipa-pure-const */
  OPT_fipa_ra = 821,                         /* -fipa-ra */
  OPT_fipa_reference = 822,                  /* -fipa-reference */
  OPT_fipa_sra = 823,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 824, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 825,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 826,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 827,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 828,              /* -fira-loop-pressure */
  OPT_fira_region_ = 829,                    /* -fira-region= */
  OPT_fira_share_save_slots = 830,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 831,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 832,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 833,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 834,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 835,               /* -fivar-visibility= */
  OPT_fivopts = 836,                         /* -fivopts */
  OPT_fjump_tables = 837,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 838,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 839,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 840,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 841,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 842,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 843, */                /* -flabels-ok */
  /* OPT_flat_namespace = 844, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 845,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 846,             /* -fleading-underscore */
  OPT_flifetime_dse = 847,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 848,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 849,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 850,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 851,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 852,                    /* -flocal-ivars */
  /* OPT_floop_block = 853, */               /* -floop-block */
  /* OPT_floop_flatten = 854, */             /* -floop-flatten */
  OPT_floop_interchange = 855,               /* -floop-interchange */
  OPT_floop_nest_optimize = 856,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 857, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 858,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 859, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 860,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 861,                      /* -flra-remat */
  OPT_flto = 862,                            /* -flto */
  OPT_flto_compression_level_ = 863,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 864,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 865,                 /* -flto-partition= */
  OPT_flto_report = 866,                     /* -flto-report */
  OPT_flto_report_wpa = 867,                 /* -flto-report-wpa */
  OPT_flto_ = 868,                           /* -flto= */
  OPT_fltrans = 869,                         /* -fltrans */
  OPT_fltrans_output_list_ = 870,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 871,              /* -fmacro-prefix-map= */
  OPT_fmath_errno = 872,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 873,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 874,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 875,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 876,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 877,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 878,                     /* -fmem-report */
  OPT_fmem_report_wpa = 879,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 880,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 881,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 882,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 883,                /* -fmessage-length= */
  ...
  /* OPT_force_cpusubtype_ALL = 924, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 925, */      /* -force_flat_namespace */
  ...
  OPT_fpreserve_control_flow = 950,          /* -fpreserve-control-flow */
  OPT_fpreserve_decisions_generic = 951,     /* -fpreserve-decisions-generic */
  ...
  OPT_fsched_critical_path_heuristic = 1010, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1011,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1012,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1013,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1014,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1015,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1016,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1017,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1018,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1019,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1020,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1021,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1022,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1023,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1024,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1025,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1026,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1027, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1028,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1029,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1030,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1031,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1032,               /* -fsection-anchors */
  /* OPT_fsee = 1033, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1034,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1035,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1036,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1037,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1038,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1039,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1040,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1041,                   /* -fshort-enums */
  OPT_fshort_wchar = 1042,                   /* -fshort-wchar */
  OPT_fshow_column = 1043,                   /* -fshow-column */
  OPT_fshrink_wrap = 1044,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1045,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1046,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1047,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1048,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1049,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1050,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1051,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1052,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1053,            /* -fsized-deallocation */
  OPT_fsjlj = 1054,                          /* -fsjlj */
  ...
  OPT_fsync_libcalls = 1088,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1089,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1090,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1091, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1092,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1093, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1094,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1095,            /* -fterminated-vtables */
  ...
  OPT_ftrapping_math = 1109,                 /* -ftrapping-math */
  OPT_ftrapv = 1110,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1111,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1112,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1113,                      /* -ftree-ccp */
  OPT_ftree_ch = 1114,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1115, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1116,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1117,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1118, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1119,                   /* -ftree-cselim */
  OPT_ftree_dce = 1120,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1121,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1122,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1123,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1124,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1125, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1126,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1127,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1128, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1129,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1130,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1131, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1132,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1133,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1134,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1135,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1136,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1137,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1138,                      /* -ftree-pre */
  OPT_ftree_pta = 1139,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1140,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1141, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1142,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1143,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1144,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1145,                     /* -ftree-slsr */
  OPT_ftree_sra = 1146,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1147, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1148, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1149,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1150,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1151,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1152, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1153,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1154, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1155,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1156,         /* -funconstrained-commons */
  OPT_funderscoring = 1157,                  /* -funderscoring */
  OPT_funit_at_a_time = 1158,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1159,              /* -funroll-all-loops */
  OPT_funroll_loops = 1160,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1161, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1162,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1163,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1164,                 /* -funsigned-char */
  OPT_funswitch_loops = 1165,                /* -funswitch-loops */
  OPT_funwind_tables = 1166,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1167,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1168,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1169,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1170,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1171,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1172,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1173,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1174,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1175,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1176,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1177, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1178,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1179,                   /* -fverbose-asm */
  /* OPT_fversion = 1180, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1181,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1182,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1183,                   /* -fvisibility= */
  OPT_fvpt = 1184,                           /* -fvpt */
  /* OPT_fvtable_gc = 1185, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1186, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1187,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1188,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1189,                     /* -fvtv-debug */
  OPT_fweak = 1190,                          /* -fweak */
  OPT_fweb = 1191,                           /* -fweb */
  /* OPT_fwhole_file = 1192, */              /* -fwhole-file */
  OPT_fwhole_program = 1193,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1194,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1195,             /* -fworking-directory */
  OPT_fwpa = 1196,                           /* -fwpa */
  OPT_fwpa_ = 1197,                          /* -fwpa= */
  OPT_fwrapv = 1198,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1199,                 /* -fwrapv-pointer */
  /* OPT_fxref = 1200, */                    /* -fxref */
  /* OPT_fzee = 1201, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1202,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1203,                     /* -fzero-link */
  OPT_g = 1204,                              /* -g */
  OPT_gant = 1205,                           /* -gant */
  OPT_gas_loc_support = 1206,                /* -gas-loc-support */
  OPT_gas_locview_support = 1207,            /* -gas-locview-support */
  /* OPT_gcoff = 1208, */                    /* -gcoff */
  /* OPT_gcoff1 = 1209, */                   /* -gcoff1 */
  /* OPT_gcoff2 = 1210, */                   /* -gcoff2 */
  /* OPT_gcoff3 = 1211, */                   /* -gcoff3 */
  OPT_gcolumn_info = 1212,                   /* -gcolumn-info */
  OPT_gdwarf = 1213,                         /* -gdwarf */
  OPT_gdwarf_ = 1214,                        /* -gdwarf- */
  OPT_gen_decls = 1215,                      /* -gen-decls */
  OPT_gfull = 1216,                          /* -gfull */
  OPT_ggdb = 1217,                           /* -ggdb */
  OPT_ggnu_pubnames = 1218,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1219,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1220, /* -ginternal-reset-location-views */
  OPT_gnat = 1221,                           /* -gnat */
  OPT_gnatO = 1222,                          /* -gnatO */
  /* OPT_gnateS = 1223, */                   /* -gnateS */
  OPT_gno_ = 1224,                           /* -gno- */
  OPT_gno_pubnames = 1225,                   /* -gno-pubnames */
  OPT_gpubnames = 1226,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1227,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1228,                   /* -gsplit-dwarf */
  OPT_gstabs = 1229,                         /* -gstabs */
  OPT_gstabs_ = 1230,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1231,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1232,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1233,                        /* -gtoggle */
  OPT_gused = 1234,                          /* -gused */
  OPT_gvariable_location_views = 1235,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1236,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1237,                           /* -gvms */
  OPT_gxcoff = 1238,                         /* -gxcoff */
  OPT_gxcoff_ = 1239,                        /* -gxcoff+ */
  OPT_gz = 1240,                             /* -gz */
  OPT_gz_ = 1241,                            /* -gz= */
  OPT_h = 1242,                              /* -h */
  OPT_headerpad_max_install_names = 1243,    /* -headerpad_max_install_names */
  OPT_idirafter = 1244,                      /* -idirafter */
  OPT_iframework = 1245,                     /* -iframework */
  OPT_imacros = 1246,                        /* -imacros */
  /* OPT_image_base = 1247, */               /* -image_base */
  OPT_imultiarch = 1248,                     /* -imultiarch */
  OPT_imultilib = 1249,                      /* -imultilib */
  OPT_include = 1250,                        /* -include */
  /* OPT_init = 1251, */                     /* -init */
  /* OPT_install_name = 1252, */             /* -install_name */
  OPT_iplugindir_ = 1253,                    /* -iplugindir= */
  OPT_iprefix = 1254,                        /* -iprefix */
  OPT_iquote = 1255,                         /* -iquote */
  OPT_isysroot = 1256,                       /* -isysroot */
  OPT_isystem = 1257,                        /* -isystem */
  OPT_iwithprefix = 1258,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1259,              /* -iwithprefixbefore */
  OPT_k8 = 1260,                             /* -k8 */
  OPT_keep_private_externs = 1261,           /* -keep_private_externs */
  OPT_l = 1262,                              /* -l */
  OPT_lang_asm = 1263,                       /* -lang-asm */
  OPT_m128bit_long_double = 1264,            /* -m128bit-long-double */
  OPT_m16 = 1265,                            /* -m16 */
  OPT_m32 = 1266,                            /* -m32 */
  OPT_m3dnow = 1267,                         /* -m3dnow */
  OPT_m3dnowa = 1268,                        /* -m3dnowa */
  OPT_m64 = 1269,                            /* -m64 */
  OPT_m80387 = 1270,                         /* -m80387 */
  OPT_m8bit_idiv = 1271,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1272,             /* -m96bit-long-double */
  OPT_mabi_ = 1273,                          /* -mabi= */
  OPT_mabm = 1274,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1275,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1276,                 /* -maddress-mode= */
  OPT_madx = 1277,                           /* -madx */
  OPT_maes = 1278,                           /* -maes */
  OPT_malign_data_ = 1279,                   /* -malign-data= */
  OPT_malign_double = 1280,                  /* -malign-double */
  OPT_malign_functions_ = 1281,              /* -malign-functions= */
  OPT_malign_jumps_ = 1282,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1283,                  /* -malign-loops= */
  OPT_malign_stringops = 1284,               /* -malign-stringops */
  OPT_march_ = 1285,                         /* -march= */
  OPT_masm_ = 1286,                          /* -masm= */
  OPT_matt_stubs = 1287,                     /* -matt-stubs */
  OPT_mavx = 1288,                           /* -mavx */
  OPT_mavx2 = 1289,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1290,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1291,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1292,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1293,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1294,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1295,                      /* -mavx512bw */
  OPT_mavx512cd = 1296,                      /* -mavx512cd */
  OPT_mavx512dq = 1297,                      /* -mavx512dq */
  OPT_mavx512er = 1298,                      /* -mavx512er */
  OPT_mavx512f = 1299,                       /* -mavx512f */
  OPT_mavx512ifma = 1300,                    /* -mavx512ifma */
  OPT_mavx512pf = 1301,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1302,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1303,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1304,                      /* -mavx512vl */
  OPT_mavx512vnni = 1305,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1306,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1307,                           /* -mbmi */
  OPT_mbmi2 = 1308,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1309,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1310,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1311,                    /* -mcet-switch */
  OPT_mcld = 1312,                           /* -mcld */
  OPT_mclflushopt = 1313,                    /* -mclflushopt */
  OPT_mclwb = 1314,                          /* -mclwb */
  OPT_mclzero = 1315,                        /* -mclzero */
  OPT_mcmodel_ = 1316,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1317,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1318, */                    /* -mcpu= */
  OPT_mcrc32 = 1319,                         /* -mcrc32 */
  OPT_mcx16 = 1320,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1321,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1322,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1323,                /* -mdynamic-no-pic */
  OPT_mf16c = 1324,                          /* -mf16c */
  OPT_mfancy_math_387 = 1325,                /* -mfancy-math-387 */
  OPT_mfentry = 1326,                        /* -mfentry */
  OPT_mfix_and_continue = 1327,              /* -mfix-and-continue */
  OPT_mfma = 1328,                           /* -mfma */
  OPT_mfma4 = 1329,                          /* -mfma4 */
  OPT_mforce_drap = 1330,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1331,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1332,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1333,                       /* -mfpmath= */
  OPT_mfsgsbase = 1334,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1335,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1336, */              /* -mfused-madd */
  OPT_mfxsr = 1337,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1338,             /* -mgeneral-regs-only */
  OPT_mgfni = 1339,                          /* -mgfni */
  OPT_mhard_float = 1340,                    /* -mhard-float */
  OPT_mhle = 1341,                           /* -mhle */
  OPT_miamcu = 1342,                         /* -miamcu */
  OPT_mieee_fp = 1343,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1344,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1345,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1346,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1347,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1348,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1349, */            /* -mintel-syntax */
  OPT_mkernel = 1350,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1351,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1352,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1353,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1354,                /* -mlong-double-80 */
  OPT_mlwp = 1355,                           /* -mlwp */
  OPT_mlzcnt = 1356,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1357,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1358,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1359,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1360,                  /* -mmitigate-rop */
  OPT_mmmx = 1361,                           /* -mmmx */
  OPT_mmovbe = 1362,                         /* -mmovbe */
  OPT_mmovdir64b = 1363,                     /* -mmovdir64b */
  OPT_mmovdiri = 1364,                       /* -mmovdiri */
  OPT_mmpx = 1365,                           /* -mmpx */
  OPT_mms_bitfields = 1366,                  /* -mms-bitfields */
  OPT_mmwaitx = 1367,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1368,            /* -mno-align-stringops */
  OPT_mno_default = 1369,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1370,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1371,                  /* -mno-push-args */
  OPT_mno_red_zone = 1372,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1373,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1374,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1375,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1376,                 /* -mone-byte-bool */
  OPT_mpc32 = 1377,                          /* -mpc32 */
  OPT_mpc64 = 1378,                          /* -mpc64 */
  OPT_mpc80 = 1379,                          /* -mpc80 */
  OPT_mpclmul = 1380,                        /* -mpclmul */
  OPT_mpcommit = 1381,                       /* -mpcommit */
  OPT_mpconfig = 1382,                       /* -mpconfig */
  OPT_mpku = 1383,                           /* -mpku */
  OPT_mpopcnt = 1384,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1385, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1386,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1387,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1388,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1389,                        /* -mprfchw */
  OPT_mpush_args = 1390,                     /* -mpush-args */
  OPT_mrdpid = 1391,                         /* -mrdpid */
  OPT_mrdrnd = 1392,                         /* -mrdrnd */
  OPT_mrdseed = 1393,                        /* -mrdseed */
  OPT_mrecip = 1394,                         /* -mrecip */
  OPT_mrecip_ = 1395,                        /* -mrecip= */
  OPT_mrecord_mcount = 1396,                 /* -mrecord-mcount */
  OPT_mred_zone = 1397,                      /* -mred-zone */
  OPT_mregparm_ = 1398,                      /* -mregparm= */
  OPT_mrtd = 1399,                           /* -mrtd */
  OPT_mrtm = 1400,                           /* -mrtm */
  OPT_msahf = 1401,                          /* -msahf */
  OPT_msgx = 1402,                           /* -msgx */
  OPT_msha = 1403,                           /* -msha */
  OPT_mshstk = 1404,                         /* -mshstk */
  OPT_mskip_rax_setup = 1405,                /* -mskip-rax-setup */
  OPT_msoft_float = 1406,                    /* -msoft-float */
  OPT_msse = 1407,                           /* -msse */
  OPT_msse2 = 1408,                          /* -msse2 */
  OPT_msse2avx = 1409,                       /* -msse2avx */
  OPT_msse3 = 1410,                          /* -msse3 */
  OPT_msse4 = 1411,                          /* -msse4 */
  OPT_msse4_1 = 1412,                        /* -msse4.1 */
  OPT_msse4_2 = 1413,                        /* -msse4.2 */
  OPT_msse4a = 1414,                         /* -msse4a */
  /* OPT_msse5 = 1415, */                    /* -msse5 */
  OPT_msseregparm = 1416,                    /* -msseregparm */
  OPT_mssse3 = 1417,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1418,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1419, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1420,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1421, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1422,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1423,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1424,            /* -mstringop-strategy= */
  OPT_mstv = 1425,                           /* -mstv */
  OPT_mtarget_linker = 1426,                 /* -mtarget-linker */
  OPT_mtbm = 1427,                           /* -mtbm */
  OPT_mtls_dialect_ = 1428,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1429,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1430,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1431,                         /* -mtune= */
  /* OPT_multi_module = 1432, */             /* -multi_module */
  /* OPT_multiply_defined = 1433, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1434, */  /* -multiply_defined_unused */
  OPT_mvaes = 1435,                          /* -mvaes */
  OPT_mveclibabi_ = 1436,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1437,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1438,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1439,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1440,                      /* -mwbnoinvd */
  OPT_mx32 = 1441,                           /* -mx32 */
  OPT_mxop = 1442,                           /* -mxop */
  OPT_mxsave = 1443,                         /* -mxsave */
  OPT_mxsavec = 1444,                        /* -mxsavec */
  OPT_mxsaveopt = 1445,                      /* -mxsaveopt */
  OPT_mxsaves = 1446,                        /* -mxsaves */
  OPT_n = 1447,                              /* -n */
  OPT_no_canonical_prefixes = 1448,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1449,              /* -no-integrated-cpp */
  OPT_no_pie = 1450,                         /* -no-pie */
  /* OPT_no_dead_strip_inits_and_terms = 1451, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1452,                          /* -nocpp */
  OPT_nodefaultlibs = 1453,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1454,                /* -nofixprebinding */
  OPT_nolibc = 1455,                         /* -nolibc */
  OPT_nomultidefs = 1456,                    /* -nomultidefs */
  OPT_noprebind = 1457,                      /* -noprebind */
  OPT_noseglinkedit = 1458,                  /* -noseglinkedit */
  OPT_nostartfiles = 1459,                   /* -nostartfiles */
  OPT_nostdinc = 1460,                       /* -nostdinc */
  OPT_nostdinc__ = 1461,                     /* -nostdinc++ */
  OPT_nostdlib = 1462,                       /* -nostdlib */
  OPT_o = 1463,                              /* -o */
  OPT_object = 1464,                         /* -object */
  OPT_p = 1465,                              /* -p */
  OPT_pagezero_size = 1466,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1467,                /* -pass-exit-codes */
  /* OPT_pedantic = 1468, */                 /* -pedantic */
  OPT_pedantic_errors = 1469,                /* -pedantic-errors */
  OPT_pg = 1470,                             /* -pg */
  OPT_pie = 1471,                            /* -pie */
  OPT_pipe = 1472,                           /* -pipe */
  OPT_prebind = 1473,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1474,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1475,                        /* -preload */
  OPT_print_file_name_ = 1476,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1477,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1478,          /* -print-multi-directory */
  OPT_print_multi_lib = 1479,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1480,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1481,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1482,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1483,               /* -print-prog-name= */
  OPT_print_search_dirs = 1484,              /* -print-search-dirs */
  OPT_print_sysroot = 1485,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1486,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1487,                 /* -private_bundle */
  OPT_pthread = 1488,                        /* -pthread */
  OPT_quiet = 1489,                          /* -quiet */
  OPT_r = 1490,                              /* -r */
  OPT_rdynamic = 1491,                       /* -rdynamic */
  OPT_read_only_relocs = 1492,               /* -read_only_relocs */
  OPT_remap = 1493,                          /* -remap */
  OPT_s = 1494,                              /* -s */
  OPT_save_temps = 1495,                     /* -save-temps */
  OPT_save_temps_ = 1496,                    /* -save-temps= */
  OPT_sectalign = 1497,                      /* -sectalign */
  OPT_sectcreate = 1498,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1499,              /* -sectobjectsymbols */
  OPT_sectorder = 1500,                      /* -sectorder */
  OPT_seg1addr = 1501,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1502, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1503, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1504, */                  /* -segaddr */
  OPT_segcreate = 1505,                      /* -segcreate */
  OPT_seglinkedit = 1506,                    /* -seglinkedit */
  OPT_segprot = 1507,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1508, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1509, */     /* -segs_read_write_addr */
  OPT_shared = 1510,                         /* -shared */
  OPT_shared_libgcc = 1511,                  /* -shared-libgcc */
  /* OPT_single_module = 1512, */            /* -single_module */
  /* OPT_specs = 1513, */                    /* -specs */
  OPT_specs_ = 1514,                         /* -specs= */
  OPT_static = 1515,                         /* -static */
  OPT_static_libasan = 1516,                 /* -static-libasan */
  OPT_static_libgcc = 1517,                  /* -static-libgcc */
  OPT_static_libgfortran = 1518,             /* -static-libgfortran */
  OPT_static_libgo = 1519,                   /* -static-libgo */
  OPT_static_liblsan = 1520,                 /* -static-liblsan */
  OPT_static_libmpx = 1521,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1522,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1523,               /* -static-libstdc++ */
  OPT_static_libtsan = 1524,                 /* -static-libtsan */
  OPT_static_libubsan = 1525,                /* -static-libubsan */
  OPT_static_pie = 1526,                     /* -static-pie */
  /* OPT_std_c__03 = 1527, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1528, */                /* -std=c++0x */
  OPT_std_c__11 = 1529,                      /* -std=c++11 */
  OPT_std_c__14 = 1530,                      /* -std=c++14 */
  OPT_std_c__17 = 1531,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1532, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1533, */                /* -std=c++1z */
  OPT_std_c__2a = 1534,                      /* -std=c++2a */
  OPT_std_c__98 = 1535,                      /* -std=c++98 */
  OPT_std_c11 = 1536,                        /* -std=c11 */
  OPT_std_c17 = 1537,                        /* -std=c17 */
  /* OPT_std_c18 = 1538, */                  /* -std=c18 */
  /* OPT_std_c1x = 1539, */                  /* -std=c1x */
  /* OPT_std_c89 = 1540, */                  /* -std=c89 */
  OPT_std_c90 = 1541,                        /* -std=c90 */
  OPT_std_c99 = 1542,                        /* -std=c99 */
  /* OPT_std_c9x = 1543, */                  /* -std=c9x */
  OPT_std_f2003 = 1544,                      /* -std=f2003 */
  OPT_std_f2008 = 1545,                      /* -std=f2008 */
  OPT_std_f2008ts = 1546,                    /* -std=f2008ts */
  OPT_std_f2018 = 1547,                      /* -std=f2018 */
  OPT_std_f95 = 1548,                        /* -std=f95 */
  OPT_std_gnu = 1549,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1550, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1551, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1552,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1553,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1554,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1555, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1556, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1557,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1558,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1559,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1560,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1561, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1562, */                /* -std=gnu1x */
  ...
  OPT_sub_library = 1575,                    /* -sub_library */
  OPT_sub_umbrella = 1576,                   /* -sub_umbrella */
  OPT_symbolic = 1577,                       /* -symbolic */
  OPT_t = 1578,                              /* -t */
  OPT_time = 1579,                           /* -time */
  OPT_time_ = 1580,                          /* -time= */
  OPT_traditional = 1581,                    /* -traditional */
  OPT_traditional_cpp = 1582,                /* -traditional-cpp */
  OPT_trigraphs = 1583,                      /* -trigraphs */
  OPT_twolevel_namespace = 1584,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1585,       /* -twolevel_namespace_hints */
  OPT_u = 1586,                              /* -u */
  /* OPT_umbrella = 1587, */                 /* -umbrella */
  OPT_undef = 1588,                          /* -undef */
  OPT_undefined = 1589,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1590, */  /* -unexported_symbols_list */
  OPT_v = 1591,                              /* -v */
  OPT_version = 1592,                        /* -version */
  OPT_w = 1593,                              /* -w */
  /* OPT_weak_reference_mismatches = 1594, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1595,                    /* -whatsloaded */
  OPT_whyload = 1596,                        /* -whyload */
  OPT_wrapper = 1597,                        /* -wrapper */
  OPT_x = 1598,                              /* -x */
  OPT_y = 1599,                              /* -y */
  OPT_z = 1600,                              /* -z */
  N_OPTS,
