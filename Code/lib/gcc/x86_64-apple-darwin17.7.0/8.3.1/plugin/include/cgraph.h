...
public:
  ...
  /* Return optional info for the compiled function.  */
  static struct cgraph_opt_info *opt_info (tree);
  ...
  /* Record a final call from SOURCE to DEST at LOCATION.  */
  static void record_final_call (tree source, tree dest, location_t location);

  /* Record a dynamic allocation in FNDECL made for DECL_OR_EXP.  */
  static void record_dynamic_alloc (tree fndecl, tree decl_or_exp);
