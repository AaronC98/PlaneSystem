...
#undef OS_EXTRA_SPEC_FUNCTIONS
#define OS_EXTRA_SPEC_FUNCTIONS DARWIN_EXTRA_SPEC_FUNCTIONS
...
/* Don't use interunit movq (between gpr and sse regs) even if the assembler
   allows it.  New clang based assembler allows it, but old gas based doesn't.
   Try to work on both cases.  */
