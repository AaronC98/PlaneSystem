...
#define gt_ggc_m_17cgraph_final_edge(X) do { \
  if (X != NULL) gt_ggc_mx_cgraph_final_edge (X);\
  } while (0)
extern void gt_ggc_mx_cgraph_final_edge (void *);
#define gt_ggc_m_20cgraph_dynamic_alloc(X) do { \
  if (X != NULL) gt_ggc_mx_cgraph_dynamic_alloc (X);\
  } while (0)
extern void gt_ggc_mx_cgraph_dynamic_alloc (void *);
#define gt_ggc_m_15cgraph_opt_info(X) do { \
  if (X != NULL) gt_ggc_mx_cgraph_opt_info (X);\
  } while (0)
extern void gt_ggc_mx_cgraph_opt_info (void *);
...
#define gt_pch_n_17cgraph_final_edge(X) do { \
  if (X != NULL) gt_pch_nx_cgraph_final_edge (X);\
  } while (0)
extern void gt_pch_nx_cgraph_final_edge (void *);
#define gt_pch_n_20cgraph_dynamic_alloc(X) do { \
  if (X != NULL) gt_pch_nx_cgraph_dynamic_alloc (X);\
  } while (0)
extern void gt_pch_nx_cgraph_dynamic_alloc (void *);
#define gt_pch_n_15cgraph_opt_info(X) do { \
  if (X != NULL) gt_pch_nx_cgraph_opt_info (X);\
  } while (0)
extern void gt_pch_nx_cgraph_opt_info (void *);
...
extern void gt_pch_p_27vec_ipa_replace_map__va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_17cgraph_final_edge
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_20cgraph_dynamic_alloc
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_15cgraph_opt_info
    (void *, void *, gt_pointer_operator, void *);
