...
static inline rtx gen_sig_rewind_lynxos178                       (void);
static inline rtx
gen_sig_rewind_lynxos178(void)
{
  return 0;
}
...
static inline rtx gen_builtin_longjmp                            (rtx);
static inline rtx
gen_builtin_longjmp(rtx ARG_UNUSED (a))
{
  return 0;
}
